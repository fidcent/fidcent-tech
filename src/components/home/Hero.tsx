...
export const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-gray-50 dark:from-fidcent-navy dark:to-black -z-10"></div>
      
      {/* Abstract shapes - Enhanced for light mode */}
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-fidcent-green/5 dark:bg-fidcent-green/10 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-fidcent-blue/5 dark:bg-fidcent-blue/10 rounded-full filter blur-3xl"></div>
        <div className="absolute top-1/2 right-1/3 w-40 h-40 bg-sky-100 dark:bg-fidcent-blue/5 rounded-full filter blur-2xl"></div>
        <div className="absolute bottom-1/4 left-1/3 w-56 h-56 bg-indigo-50 dark:bg-fidcent-green/5 rounded-full filter blur-2xl"></div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/services">
                  <Button size="lg" variant="outline" className="bg-white/80 dark:bg-transparent border-gray-200 hover:border-fidcent-green">
                    Our Services
                  </Button>
                </Link>
              </div>
            ...
            <div className="glass-card rounded-2xl overflow-hidden shadow-xl animate-fade-in-up border border-gray-100 dark:border-gray-800/20 soft-shadow">
              <div className="relative aspect-[4/3] bg-gradient-to-br from-fidcent-green/5 to-fidcent-blue/5 p-8 flex items-center justify-center">
                <div className="absolute w-24 h-24 bg-fidcent-green/10 rounded-full top-12 left-12 filter blur-xl"></div>
                <div className="absolute w-32 h-32 bg-fidcent-blue/10 rounded-full bottom-12 right-12 filter blur-xl"></div>
