...
export const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-gray-50 dark:from-fidcent-navy dark:to-black -z-10"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/services">
                  <Button size="lg" variant="outline" className="bg-white/80 dark:bg-transparent">
                    Our Services
                  </Button>
                </Link>
              </div>
              ...
              <div className="pt-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {techStack.map((tech, idx) => (
                    <div key={idx} className="flex items-center gap-2 px-3 py-2 rounded-full bg-white dark:bg-fidcent-navy/80 shadow-sm border border-gray-100 dark:border-gray-800 hover-card">
            ...
            <div className="glass-card rounded-2xl overflow-hidden shadow-xl animate-fade-in-up border border-gray-100 dark:border-gray-800/20 soft-shadow">
              <div className="relative aspect-[4/3] bg-gradient-to-br from-fidcent-green/10 to-fidcent-blue/10 p-8 flex items-center justify-center">
                <div className="absolute w-24 h-24 bg-fidcent-green/20 rounded-full top-12 left-12 filter blur-xl"></div>
                <div className="absolute w-32 h-32 bg-fidcent-blue/20 rounded-full bottom-12 right-12 filter blur-xl"></div>
